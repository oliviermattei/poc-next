...
| **Emails transactionnels** (React Email, adapter Resend/SMTP, templates traduits, guide DNS DKIM/SPF/DMARC) | 3 | Adapter provider + templates. Le guide de délivrabilité est de la doc, pas du code. |
