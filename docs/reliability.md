...
- Aucun port ne dépend d'une clé d'API pour fonctionner **en développement local** : capture locale des emails, stockage sur disque, jobs synchrones, analytique inerte.
