 ...
 * `@repo/adapter-sentry`) : un adaptateur ne dépend d'aucun package du dépôt
 ...
 * pas la même forme : des propriétés scalaires ici, un contexte et une trace
 * là-bas.
 *
...
export interface RedactionOutcome<TValue> {
  ...
  /** Les **noms** des champs retirés — jamais leurs valeurs (`AnalyticsLogRecord`). */
